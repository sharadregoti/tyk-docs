...
* `version_data.{version-name}.extended_paths.url_rewrites`: Configuration for the [URL rewrite]({{< ref "transform-traffic/url-rewriting#url-rewriting-overview" >}}) middleware.
