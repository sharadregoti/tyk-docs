...
Tyk Streams is currently a Lab release feature. If a crash or an issue is encountered then Tyk Gateway can be restarted and the logs can be inspected as follows:
